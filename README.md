...
| --- | --- | --- | --- |
| `minecraft-data@3.111.0+complexity.26.2.4` | 26.2 | 776 | 4903 |
...
```bash
npm install "https://github.com/Complexity-ML/node-minecraft-data-26.2/releases/download/complexity-26.2.4/minecraft-data-complexity-26.2.4.tgz"
```
